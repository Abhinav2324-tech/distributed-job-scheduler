...
const FEATURES = [
  ["Atomic claiming", "No two workers ever process the same job, even under heavy concurrency."],
  ["Automatic retries", "Configurable backoff strategies and a dead letter queue for exhausted jobs."],
  ["Live visibility", "Queue depth, throughput, and worker health update in real time."],
] as const;
